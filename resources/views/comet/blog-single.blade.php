          ...
          <div class="col-md-8">
            <article class="post-single">
              <div class="post-info">
                ...
                <h6 class="upper"><span>By</span><a href="#"> {{ $single_post ->user ->name }}</a><span class="dot"></span><span> {{date('d, F,Y', strtotime($single_post ->created_at))}} </span><span class="dot"></span>
              ...
              <div class="post-media">
                {{--{{'data have in json pattern' and array have in variable $featured }}--}}

                @php
                $featured = json_decode($single_post ->featured);  //convert into  array from stdClass object
                // echo "<pre>";
                // print_r($featured);
                @endphp
